...
def main [cloudflare_account_id: string, cloudflare_api_token: string] {
    ...
    CLOUDFLARE_ACCOUNT_ID=$cloudflare_account_id CLOUDFLARE_API_TOKEN=$cloudflare_api_token wrangler pages deploy --help --project-name vyas-n --branch $current_git_branch ./result
}
